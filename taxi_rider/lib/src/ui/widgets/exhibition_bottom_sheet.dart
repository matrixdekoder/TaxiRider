...
import 'package:taxirider/src/ui/pages/register.dart';
import 'package:taxirider/src/ui/widgets/loading_dialog.dart';
import 'package:taxirider/src/ui/widgets/msg_dialog.dart';
  ...
  Widget build(BuildContext context) {
    return Positioned(
        ...
        child: AnimatedOpacity(
            opacity: isVisible ? 1 : 0,
            duration: Duration(milliseconds: 200),
            child: Text("Get moving with Taxi",
